...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial record ProductSearchModel : BaseSearchModel
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.List.SearchYearOfReleaseDate")]
        public string SearchYearOfReleaseDate { get; set; }

        //[NopResourceDisplayName("Admin.Catalog.Products.List.SearchMonthOfReleaseDate")]
        //public string SearchMonthOfReleaseDate { get; set; }
